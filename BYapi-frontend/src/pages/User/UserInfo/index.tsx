...
import { fileUpload, modifyPassword, userModify } from '@/services/ant-design-pro/api';
  ...
  return (
    <>
      ...
      <Descriptions bordered column={4}>
        ...
        <Descriptions.Item label="用户账号" span={1.5}>
          {myUser.userAccount}
        </Descriptions.Item>
        <Descriptions.Item label="用户头像" span={1.5}>
          <Image
            src={myUser.avatarUrl === null ? DEFAULT_AVATAR_URL : myUser.avatarUrl}
            width={50}
            height={50}
        ...
        <Descriptions.Item label="用户邮箱" span={1.5}>
          {myUser.email}
        </Descriptions.Item>
      </Descriptions>
      ...
      <ModalForm<API.CurrentUser>
        title="修改本用户信息"
        trigger={
          <Button type="primary" shape="round" style={{ marginTop: '50px', marginLeft: '50px' }}>
            修改信息
          </Button>
        }
        autoFocusFirstInput
      ...
      >
        <ProForm.Group>
          ...
          {/*<ProFormUploadDragger label="用户头像"
                                name="avatarUrl"
      ...
      <ModalForm<API.ModifyPasswordParam>
        title="修改密码"
        trigger={
          <Button danger shape="round" style={{ margin: '30px' }}>
            修改密码
          </Button>
        }
        autoFocusFirstInput
